    ...
    if (choice == "1"):
        ...
        while True:
            try:
                ...
                yt.streams.filter(res="1080p").download(output_path = f"YouTube/Video's/{yt.video_id}/", filename = "video.mp4")
                break
            except:
                print("Het is niet gelukt om de video in 1080p te downloaden we proberen nu 720p")
            try:
                yt.streams.filter(res="720p").download(output_path = f"YouTube/Video's/{yt.video_id}/", filename = "video.mp4")
            ...
            try:
                yt.streams.filter(res="480p").first().download(output_path = f"YouTube/Video's/{yt.video_id}/", filename = "video.mp4")
            ...
            try:
                yt.streams.filter(res="360p").first().download(output_path = f"YouTube/Video's/{yt.video_id}/", filename = "video.mp4")
